...
- [x] **Step 1: Viết failing test cho `updateAppListFromUrl`**
...
- [x] **Step 3: Cập nhật `AppsRepository.updateAppListFromUrl`**
  ```dart
...
- [x] **Step 1: Viết failing test cho parse checksum metadata**
...
- [x] **Step 3: Triển khai thuộc tính `versionSha256Json` trong `AppModel` và parse trong `AppsRepository`**
...
- [x] **Step 1: Viết failing test cho `verifyFileChecksum`**
...
- [x] **Step 3: Triển khai `verifyFileChecksum` và tích hợp vào `_downloadPayload` trong `AppInstallerService`**
...
- [x] **Step 1: Viết failing test cho `LocalSecretVault`**
...
- [x] **Step 3: Triển khai `LocalSecretVault`**
...
- [x] **Step 1: Viết failing test cho lưu trữ mật khẩu mã hóa**
...
- [x] **Step 3: Cập nhật `DatabasesNotifier` trong `databases_provider.dart`**
...
- [x] **Step 3: Cập nhật checklist tài liệu kế hoạch Phase 4**
